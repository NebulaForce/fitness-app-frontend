...
export function useContract() {
  ...
  const contractAddress = '0x8fE793Bf8E33Eb3739C87eae30E5Fa032e9F5ee7'; //TODO: Change this to the address of your deployed contract
  ...
  const getGoalData = () => { return goalData };
